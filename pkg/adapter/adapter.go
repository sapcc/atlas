...
func NewAdapter(ctx context.Context, fileName string, name string, d discovery.Discoverer, configMap string, isConfigmap bool, namespace string, logger log.Logger) *Adapter {
	return &Adapter{
		ctx:         ctx,
		disc:        d,
