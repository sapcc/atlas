...
require (
	...
	github.com/hashicorp/consul v0.0.0-20170112012924-23ce10f88913 // indirect
...
replace github.com/hosting-de-labs/go-netbox => github.com/stefanhipfel/go-netbox v1.0.5-api2.7.7
